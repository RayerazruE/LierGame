...
class FourthActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // ThirdActivity로부터 데이터를 받아옵니다.
        shuffledNames = intent.getStringArrayListExtra("shuffledNames") ?: ArrayList()
        Log.e("체크","4-3${shuffledNames[0]}");
        Log.e("체크","4-3${shuffledNames[1]}");
        Log.e("체크","4-3${shuffledNames[2]}");
        Log.e("체크","4-3${shuffledNames[3]}");
        lierName = intent.getStringExtra("lierName") ?: ""
        Log.e("체크","4-유저데이터받아오기");
        Log.e("체크","4-$lierName");

        // 스트링인덱스 받아오기
        stringIndex = intent.getIntExtra("stringIndex", 0)
        Log.e("체크","4-스트링인덱스받아오기");
        Log.e("체크","4-$stringIndex");

        // 섞인 명사 배열을 Intent에서 가져옵니다.
        shuffledNounsArray = intent.getStringArrayExtra("shuffledNouns") as Array<String>;
        Log.e("체크","4-명사배열받아오기");
        Log.e("체크","4-${shuffledNounsArray[0]}");
        Log.e("체크","4-${shuffledNounsArray[1]}");
        Log.e("체크","4-${shuffledNounsArray[2]}");
        Log.e("체크","4-${shuffledNounsArray[3]}");
